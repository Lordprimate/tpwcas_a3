...
if(isNil "bdetect_units_kindof") then { bdetect_units_kindof = ["CaManBase","StaticWeapon","Ship","Car","Tank","Air"]; }; 										// CfgVehicles classes being subject to suppression effects, example: ["CaManBase","StaticWeapon","Car_f","Tank_f","Air"]
